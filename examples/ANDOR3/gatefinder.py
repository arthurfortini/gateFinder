...
editor.modifySpecificDB(editor.inPerturber[0], -1, "y")
editor.modifySpecificDB(editor.inPerturber[2], 1, "y")


editor.modifySpecificDB(editor.inputs[1], 1, "x")
editor.modifySpecificDB(editor.inPerturber[1], 1, "x")
editor.modifySpecificDB(editor.std[1], 1, "x")
