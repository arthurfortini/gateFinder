...
randomizer.modifySpecificDB(randomizer.inPerturber[0], -1, "y")
randomizer.modifySpecificDB(randomizer.inPerturber[2], 1, "y")


randomizer.modifySpecificDB(randomizer.inputs[1], 1, "x")
randomizer.modifySpecificDB(randomizer.inPerturber[1], 1, "x")
randomizer.modifySpecificDB(randomizer.std[1], 1, "x")
