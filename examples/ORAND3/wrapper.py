...
randomizer.modifyInputAngle(randomizer.std[1], randomizer.inputs[1], randomizer.inPerturber[1], -180)
randomizer.modifyInputAngle(randomizer.std[2], randomizer.inputs[2], randomizer.inPerturber[2], -120)

randomizer.modifySpecificDB(randomizer.inPerturber[0], 3, "y")
randomizer.modifySpecificDB(randomizer.inPerturber[0], 1, "x")
randomizer.modifySpecificDB(randomizer.inPerturber[2], -3, "y")
randomizer.modifySpecificDB(randomizer.inPerturber[2], 1, "x")

(n,m,l) = randomizer.inPerturber[0].latcoord
randomizer.changecoord(randomizer.inPerturber[0], n, m, 0)
(n,m,l) = randomizer.inPerturber[2].latcoord
randomizer.changecoord(randomizer.inPerturber[2], n, m, 1)

randomizer.modifySpecificDB(randomizer.inputs[1], 2, "x")
randomizer.modifySpecificDB(randomizer.inPerturber[1], 2, "x")
randomizer.modifySpecificDB(randomizer.std[1], 2, "x")
